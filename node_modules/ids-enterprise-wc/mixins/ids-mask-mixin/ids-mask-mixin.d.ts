import { IdsMaskOptions } from '../../components/ids-mask/ids-mask-common';
 ...
 */
declare const IdsMaskMixin: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
        maskState: MaskState;
         ...
         */
        readonly maskAPI: import("../../components/ids-mask/ids-mask-api").default;
        maskGuide: boolean;
        /**
         ...
         */
        processMask: (rawValue: string, opts?: IdsMaskOptions, doSetValue?: boolean) => any;
        /**
         ...
         * @returns {void}
         */
        safelySetSelection(host?: ShadowRoot | Document | null, startPos?: number, endPos?: number): void;
