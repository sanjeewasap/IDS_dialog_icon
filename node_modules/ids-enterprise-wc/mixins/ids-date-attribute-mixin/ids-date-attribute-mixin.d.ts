...
type Constraints = IdsConstructor<DateAttributeInterface & LocaleMixinInterface & LocaleHandler & EventsMixinInterface & CalendarEventsHandler>;
/**
 ...
 */
declare const IdsDateAttributeMixin: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
        dateValue: Date | null;
        ...
        language: string;
        setDirection(): void;
        localeAPI: import("../../components/ids-locale/ids-locale").default;
        onLocaleChange?: ((locale?: import("../../components/ids-locale/ids-locale").default | undefined) => void) | undefined;
        onLanguageChange?: ((locale?: import("../../components/ids-locale/ids-locale").default | undefined) => void) | undefined;
        ...
        onEventsChange?(data: import("../../components/ids-calendar/ids-calendar-event").CalendarEventData[]): void;
        onEventTypesChange?(data: import("../../components/ids-calendar/ids-calendar-event").CalendarEventTypeData[]): void;
