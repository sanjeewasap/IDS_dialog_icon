 ...
 */
declare const IdsAttachmentMixin: <T extends IdsBaseConstructor>(superclass: T) => {
    new (...args: any[]): {
        /**
         * Original parent element reference
         */
        originalParentElement?: IdsPopupElementRef | undefined;
        /**
         * Attachment behavior's target element reference
         */
        attachmentParentElement?: IdsPopupElementRef | undefined;
        /**
