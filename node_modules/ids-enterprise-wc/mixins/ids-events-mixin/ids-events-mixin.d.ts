 ...
 */
declare const IdsEventsMixin: <T extends IdsBaseConstructor>(superclass: T) => {
    new (...args: any[]): {
        handledEvents: Map<any, any>;
        longPressOn: boolean;
        swipeOn: boolean;
        ...
        hoverEndOn: boolean;
        isClick: boolean;
        timer?: FrameRequestLoopHandler | null | undefined;
        slopedMouseLeaveTimer?: FrameRequestLoopHandler | null | undefined;
        /** Starting pageX */
        startX: number;
        /** Starting pageY */
        startY: number;
         ...
         */
        onEvent(eventName: string, target: any, callback?: ((evt: any) => void) | undefined, options?: EventOptions): void;
        /**
         ...
         */
        offEvent(eventName: string, target?: unknown, options?: EventOptions): void;
        /**
         ...
         */
        triggerEvent(eventName: string, target: any, options?: CustomEventInit<unknown>): void;
        /**
         ...
         * @param {EventOptions} options Additional event settings (passive, once, bubbles ect)
         */
        "__#3@#addLongPressListener"(eventName: string, target: Element, options?: EventOptions): void;
        /**
         ...
         * @param {EventOptions} options Additional event settings (passive, once, bubbles ect)
         */
        "__#3@#addSwipeListener"(eventName: string, target: Element, options?: EventOptions): void;
        /**
         ...
         * @param {EventOptions} options Additional event settings (passive, once, bubbles ect)
         */
        "__#3@#addHoverEndListener"(eventName: string, target: Element, options?: EventOptions): void;
        /**
         ...
         * @param {EventOptions} options Additional event settings (passive, once, bubbles ect)
         */
        "__#3@#addSlopedMouseLeaveListener"(eventName: string, target: Element, options?: EventOptions): void;
        /**
         ...
         */
        "__#3@#addKeyDownEndListener"(target: HTMLElement, options?: Record<string, unknown>): void;
        /**
         * Clear the timer
         * @private
         */
