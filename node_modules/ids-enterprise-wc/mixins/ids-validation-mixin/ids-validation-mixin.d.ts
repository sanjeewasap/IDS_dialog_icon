 ...
 */
declare const IdsValidationMixin: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
        isTypeNotValid?: any;
         ...
         */
        readonly validationMessages: IdsValidationErrorMessage[];
        /**
        ...
        cachedNonce: string; /** The unique id in the check messages */
