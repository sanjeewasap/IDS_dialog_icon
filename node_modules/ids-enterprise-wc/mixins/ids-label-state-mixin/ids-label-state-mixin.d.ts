 ...
 */
declare const IdsLabelStateMixin: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
         ...
         * @returns {void}
         */
        "__#11@#refreshLabelState"(oldVariantName: IdsLabelStateMode, newVariantName: IdsLabelStateMode): void;
        "__#11@#setlabelState"(doHide?: IdsLabelStateMode): void;
