 ...
 */
declare const IdsColorVariantMixin: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
         ...
         * @returns {void}
         */
        "__#6@#refreshColorVariant"(oldVariantName?: string | null, newVariantName?: string | null): void;
        onColorVariantRefresh?(variantName: string | undefined | null): void;
