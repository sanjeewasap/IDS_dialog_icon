...
export default class IdsToolbar extends Base {
     ...
     */
    navigate(amt?: number, doFocus?: boolean): HTMLElement;
    template(): string;
    /**
     ...
     * @returns {void}
     */
    triggerSelectedEvent(elem: any, triggeredFromOverflow?: boolean): void;
}
export {};
