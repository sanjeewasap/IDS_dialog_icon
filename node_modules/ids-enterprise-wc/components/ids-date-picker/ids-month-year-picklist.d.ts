...
declare const Base: {
    new (...args: any[]): {
        ...
        onEventsChange?(data: import("../ids-calendar/ids-calendar-event").CalendarEventData[]): void;
        onEventTypesChange?(data: import("../ids-calendar/ids-calendar-event").CalendarEventTypeData[]): void;
 ...
 */
declare class IdsMonthYearPicklist extends Base {
    constructor();
    connectedCallback(): void;
    disconnectedCallback(): void;
     ...
     */
    onLocaleChange: () => void;
    activatePicklist(): void;
    deactivatePicklist(): void;
}
