...
declare const IdsAutoComplete: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
        /**
         ...
         */
        setSelectedOption(el: Element | any): void;
        /**
         * Remove the selected attributes on the current option
         * @param {Element | any} el element
         */
        removeSelectedOption(el: Element | any): void;
        /**
