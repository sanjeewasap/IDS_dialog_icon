...
declare const IdsListViewSearchMixin: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
         ...
         */
        searchFilterCallback: ((term: string) => (item: SearchItem) => boolean) | null;
        /**
         * Searchable text callback
         */
        searchableTextCallback: ((item: SearchItem) => string) | null;
        /**
         * Current search term
         */
        "__#51@#term": string;
         ...
         */
        readonly searchField: IdsSearchField | null | undefined;
        /**
         ...
         */
        "__#51@#objectPropsAsText"(item: string | HTMLElement | object): string;
        /**
         ...
         * @returns {string|HTMLElement|object} The searchable content
         */
        "__#51@#searchableContent"(item: string | HTMLElement | object): string;
        /**
