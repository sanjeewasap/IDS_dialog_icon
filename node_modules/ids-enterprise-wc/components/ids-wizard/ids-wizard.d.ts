 ...
 */
export default class IdsWizard extends IdsWizard_base {
    constructor();
    /**
     * whether to update callbacks after
     * a render() event
     */
    shouldUpdateCallbacks: boolean;
    ...
    set clickable(value: string | null);
    get clickable(): string | null;
    connectedCallback(): void;
    /**
