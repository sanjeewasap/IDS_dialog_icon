...
declare const IdsDataGridHeader_base: {
    new (...args: any[]): {
...
export default class IdsDataGridHeader extends IdsDataGridHeader_base {
    #private;
    rootNode?: any;
     ...
     */
    isHeaderExpanderCollapsed: boolean;
    constructor();
    connectedCallback(): void;
    /**
     ...
     */
    setIsHeaderExpanderCollapsed(): void;
    /**
     * Set the header checkbox state
     * @private
     */
    setHeaderCheckbox(): void;
    /**
     ...
     */
    setSortState(id: string, ascending: boolean): void;
    /**
     ...
     */
    static headerCellTemplate(dataGrid: IdsDataGrid, column: IdsDataGridColumn, index: number): string;
    /**
