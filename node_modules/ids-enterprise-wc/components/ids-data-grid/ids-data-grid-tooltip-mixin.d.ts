 ...
 */
declare const IdsDataGridTooltipMixin: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
         ...
         */
        "__#132@#handleTooltip"(e: MouseEvent): Promise<void>;
        /**
         * Handle tooltip for body cell
         * @private
         * @param  {HTMLElement[]} path List of path element.
         */
        "__#132@#tooltipBodyCell"(path: HTMLElement[]): Promise<void>;
        /**
         * Handle tooltip for header title or header icon
         * @private
         * @param  {HTMLElement[]} path List of path element.
         */
        "__#132@#tooltipHeaderTitleOrIcon"(path: HTMLElement[]): Promise<void>;
        /**
         * Handle tooltip for header filter button
         * @private
         * @param  {HTMLElement[]} path List of path element.
         */
        "__#132@#tooltipFilterButton"(path: HTMLElement[]): Promise<void>;
        /**
         * Set tooltip css part.
         * @private
         * @param  {object} opt The options.
         */
        "__#132@#setTooltipCssPart"(opt: any): Promise<void>;
        /**
         ...
         * @returns {void}
         */
        "__#132@#tooltipContent"(opt: any): Promise<string>;
        /**
         ...
         * @returns {void}
         */
        "__#132@#tooltipOptions"(opt: any): Promise<IdsDataGridTooltipOptions>;
        /**
         ...
         * @returns {void}
         */
        "__#132@#showTooltip"(opt: any): void;
        /**
         * Handle to hide tooltip
         * @private
         * @returns {void}
         */
        "__#132@#hideTooltip"(): void;
        "__#132@#mouseOut": boolean;
        /**
         * Add tooltip and attach all tooltip events
         * @private
         * @returns {void}
         */
        "__#132@#attachTooltip"(): void;
        /**
         * Detach tooltip and all tooltip events
         * @private
         * @returns {void}
         */
        "__#132@#detachTooltip"(): void;
