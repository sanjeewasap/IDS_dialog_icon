...
export default class IdsTreeNode extends Base {
     ...
     */
    getTemplate(isGroup?: boolean): string;
    /**
     ...
     */
    treeAttribute(selector: string): string | null | undefined;
    /**
     ...
     */
    get isSelected(): string | boolean;
    get checkbox(): Element | null | undefined;
    /**
     * Gets the current state is tabbable or not
     * @returns {boolean} the state is tabbable or not
     */
    get isTabbable(): string | boolean;
