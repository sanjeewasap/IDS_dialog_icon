...
export default class IdsTree extends Base {
     ...
     */
    getParentNode(node: HTMLElement | any): any;
    /**
     ...
     */
    selectParentNodes(parent: HTMLElement | any): void;
    /**
     * Select nodes under given parent node
     * @param {HTMLElement | any} node element
     */
    selectNestedNodes(node: HTMLElement | any): void;
    /**
     * Unselect nodes under given parent node
     * @param {HTMLElement | any} node element
     */
    unselectNestedNodes(node: HTMLElement | any): void;
    /**
    ...
    get useToggleTarget(): boolean | string;
}
export {};
