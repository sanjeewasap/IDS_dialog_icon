...
export default class IdsMenu extends Base {
     ...
     */
    menuContentTemplate(contentsObj: any): string;
    /**
     ...
     */
    get parentMenu(): IdsMenu | null | undefined;
    /**
     * @readonly
     * @returns {HTMLElement} parent menu item, if this menu is a submenu
     */
    get parentMenuItem(): IdsMenuItem | null | undefined;
    /**
     * @readonly
     ...
     * @returns {void}
     */
    highlightItem(menuItem: any): void;
    /**
     ...
     */
    navigate(amt?: number, doFocus?: boolean): any;
    /**
     ...
     */
    getSelectedItems(menuGroup?: any): any;
    /**
     * @param {string|HTMLElement} [menuGroup] a string representing an ID, or an IdsMenuGroup
     * directly, that optionally limits results to within a specified menu group.
     * @returns {Array<any>} list of the values contained by selected menu items
     */
    getSelectedValues(menuGroup: any): any;
    /**
     ...
     * @returns {void}
     */
    clearSelectedItems(menuGroup: any): void;
    /**
