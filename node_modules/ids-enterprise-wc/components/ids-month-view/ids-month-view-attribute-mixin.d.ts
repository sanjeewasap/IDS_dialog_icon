...
import type { IdsRangeSettings, IdsRangeSettingsInterface, IdsLegend, IdsLegendSettings, IdsDisableSettings } from './ids-month-view-common';
 ...
 */
declare const IdsMonthViewAttributeMixin: <T extends Constraints>(superclass: T) => {
    new (...args: any[]): {
        "__#103@#disableSettings": IdsDisableSettings;
        "__#103@#currentLegend": IdsLegendSettings;
        "__#103@#rangeSettings": IdsRangeSettings;
