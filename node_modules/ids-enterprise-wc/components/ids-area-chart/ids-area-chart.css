/* Ids Area Chart Component */ /* Ids Axis Chart Component */
.chart-legend {
  display: flex;
...
.ids-axis-chart .areas {
  fill-opacity: 0.2;
}
.ids-axis-chart .areas [part=area] {
  outline: none;
}
.ids-axis-chart .areas path.color-1 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-1);
}
.ids-axis-chart .areas path.color-2 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-2);
}
.ids-axis-chart .areas path.color-3 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-3);
}
.ids-axis-chart .areas path.color-4 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-4);
}
.ids-axis-chart .areas path.color-5 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-5);
}
.ids-axis-chart .areas path.color-6 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-6);
}
.ids-axis-chart .areas path.color-7 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-7);
}
.ids-axis-chart .areas path.color-8 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-8);
}
.ids-axis-chart .areas path.color-9 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-9);
}
.ids-axis-chart .areas path.color-10 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-10);
}
.ids-axis-chart .areas path.color-11 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-11);
}
.ids-axis-chart .areas path.color-12 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-12);
}
.ids-axis-chart .areas path.color-13 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-13);
}
.ids-axis-chart .areas path.color-14 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-14);
}
.ids-axis-chart .areas path.color-15 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-15);
}
.ids-axis-chart .areas path.color-16 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-16);
}
.ids-axis-chart .areas path.color-17 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-17);
}
.ids-axis-chart .areas path.color-18 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-18);
}
.ids-axis-chart .areas path.color-19 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-19);
}
.ids-axis-chart .areas path.color-20 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-20);
}
.ids-axis-chart .areas path.color-21 {
  /* stylelint-disable-next-line custom-property-pattern */
  fill: var(--ids-chart-color-21);
}
.ids-axis-chart .animate {
  animation: fadein 2.8s cubic-bezier(0.17, 0.04, 0.03, 0.94) forwards;
}

.ids-chart-container.selectable .ids-axis-chart .areas [part=area] {
  cursor: pointer;
}
.ids-chart-container.selectable .ids-axis-chart .areas [part=area].selected, .ids-chart-container.selectable .ids-axis-chart .areas [part=area][selected] {
  opacity: 1;
}
.ids-chart-container.selectable .ids-axis-chart .areas [part=area].not-selected {
  opacity: 0.35;
}
