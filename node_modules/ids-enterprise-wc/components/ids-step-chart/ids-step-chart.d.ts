...
declare const IdsStepChart_base: {
    new (...args: any[]): {
 ...
 */
export default class IdsStepChart extends IdsStepChart_base {
    #private;
     ...
     */
    get stepsInProgress(): string | Array<string | number>;
    /**
