...
declare const Base: {
    new (...args: any[]): {
        ...
        legendTemplate(setting?: string): string;
        adjustLabels(): void;
        ...
        setSelection?(dataIndex: string, isLegendClick?: boolean | undefined): void;
    ...
    new (...args: any[]): {
        ...
        connectedCallback(): void;
        attachSelectionEvents(): void; /** The min value in all groups */
        detachSelectionEvents(): void;
        "__#92@#init"(): void;
        "__#92@#doSelectableChange"(value: boolean): void;
        selectable: boolean;
        onEvent(eventName: string, target?: any, callback?: ((evt: any) => void) | undefined, options?: import("../../mixins/ids-events-mixin/ids-events-mixin").EventOptions | undefined): void;
        offEvent(eventName: string, target?: any, options?: import("../../mixins/ids-events-mixin/ids-events-mixin").EventOptions | undefined): void;
        triggerEvent(eventName: string, target: any, options?: CustomEventInit<any> | undefined): void;
        ...
        detachEventsByName: (eventName: string) => void;
        handledEvents: Map<any, any>;
        onSelectableChange?(value?: boolean | undefined): void;
        setSelection?(dataIndex: string, isLegendClick?: boolean | undefined): void;
        name?: string | undefined;
        state: Record<string, any>;
        cachedNonce: string;
...
export default class IdsAxisChart extends Base implements ChartSelectionHandler {
     ...
     */
    tooltipData(index: number, groupIndex?: number): {
        label: any;
        value: any;
        tooltip: any;
    };
     ...
     * @private
     */
    formatYLabel(value: string | ((value: unknown, data: Array<IdsChartData>, api: this) => string)): any;
    /**
     ...
     * @param {object} value The margin values
     */
    set textWidths(value: IdsChartDimensions);
