...
export default class IdsDropdownList extends Base {
     ...
     */
    get options(): NodeListOf<IdsListBoxOption>;
    /**
     ...
     */
    getOption(val: string): IdsListBoxOption | null | undefined;
    /**
     * Set the aria and state on the element
     * @param {HTMLElement} option the option to select
     * @private
     */
    selectOption(option: IdsListBoxOption | string): void;
    /**
