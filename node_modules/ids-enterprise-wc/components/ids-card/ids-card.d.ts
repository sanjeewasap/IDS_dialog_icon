...
declare const Base: {
    new (...args: any[]): {
        ...
        removeRipples(): void;
        "__#8@#removeRippleListeners"(): void;
        "__#8@#attachRippleListeners"(): void;
        createRipple(x: number | undefined, y: number | undefined): Promise<void>;
        "__#8@#triggerRippleEndEvent"(rippleEl: HTMLElement): void;
...
export default class IdsCard extends Base {
     ...
     * @returns {string} html
     */
    actionableButtonTemplate(): string;
    /**
     * Method for actionable link card template
     * @returns {string} html
     */
    actionableLinkTemplate(): string;
    /**
     ...
     */
    set autoHeight(value: string | null);
    get autoHeight(): string | null;
    /**
     ...
     * @returns {string} target for ids-hyperlink
     */
    get noHeader(): string | null;
    set noHeader(value: string | null);
}
export {};
