 ...
 */
declare class IdsTimePickerPopup extends Base {
    #private;
    private isRendering;
    constructor();
    connectedCallback(): void;
     ...
     */
    get applyButtonEl(): IdsModalButton | null | undefined;
    /**
     * @readonly
     * @returns {NodeList<IdsTimePickerPopupButton>} containing all buttons in the Date Picker Popup
     */
    get buttons(): NodeListOf<IdsTimePickerPopupButton> | undefined;
    /**
     * @readonly
     * @returns {HTMLDivElement} containing element for Time Picker dropdowns
     */
    get dropdownContainerEl(): HTMLDivElement | null | undefined;
    /**
