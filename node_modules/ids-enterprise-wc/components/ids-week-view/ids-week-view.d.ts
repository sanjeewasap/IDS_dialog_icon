...
import { FrameRequestLoopHandler } from '../../utils/ids-timer-utils/ids-timer-utils';
...
declare const Base: {
    ...
    new (...args: any[]): {
        "__#102@#eventsData": CalendarEventData[];
        "__#102@#eventTypesData": CalendarEventTypeData[];
        ...
        "__#102@#triggerViewChange"(view: "day" | "month" | "year", activeDate?: Date | undefined): void;
...
export default class IdsWeekView extends Base {
     ...
     */
    changeDate(type: 'next' | 'previous' | 'today'): void;
    /**
