...
declare const Base: {
    ...
    new (...args: any[]): {
        ...
        "__#35@#currentPopupOpenEventsTarget": import("../ids-popup/ids-popup-attributes").IdsPopupElementRef;
        addOpenEvents(): void;
    ...
    new (...args: any[]): {
        ...
        connectedCallback(): void;
        disconnectedCallback(): void;
        "__#34@#setAttachmentParent"(val: string | null): void;
...
declare class IdsPickerPopup extends Base implements IdsPickerPopupCallbacks {
    constructor();
    connectedCallback(): void;
    disconnectedCallback(): void;
     ...
     * @returns {void}
     */
    hide(doFocus?: boolean): Promise<void>;
    onShow?(): void;
    /**
     * @returns {void}
     */
