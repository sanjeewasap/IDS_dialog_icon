import{b as u}from"./ids-chunk-NZGHOKVC.js";import{b as c}from"./ids-chunk-5RRSUJN3.js";import{a as d,b as s}from"./ids-chunk-XE4WFW5M.js";import{e as i}from"./ids-chunk-QPDOZZIG.js";import{a as t}from"./ids-chunk-EQJWBFQ2.js";import{a}from"./ids-chunk-U7OOVFXE.js";var l=`
/**
...
.ids-trigger-button.inherit-color {
  color: currentColor;
}`;var n=class extends u(c){constructor(){super()}static get attributes(){return[...super.attributes,t.INLINE,t.INHERIT_COLOR,t.READONLY,t.TABBABLE]}connectedCallback(){super.connectedCallback(),this.inline=i(this.getAttribute(t.INLINE)),this.readonly=i(this.getAttribute(t.READONLY))}get protoClasses(){return["ids-trigger-button"].concat(super.protoClasses)}set tabbable(r){let e=i(r),o=this.shadowRoot?.querySelector("button");if(e){this.setAttribute(t.TABBABLE,""),o&&(o.tabIndex=0);return}this.removeAttribute(t.TABBABLE),o&&(o.tabIndex=-1)}get tabbable(){return i(this.getAttribute(t.TABBABLE))}set readonly(r){let e=i(r),o=this.shadowRoot?.querySelector("button");if(e){this.setAttribute(t.READONLY,""),o&&(o.tabIndex=-1,o.setAttribute("readonly",""));return}o&&(o.tabIndex=this.tabbable?0:-1,o.removeAttribute("readonly")),this.removeAttribute(t.READONLY)}get readonly(){return i(this.getAttribute(t.READONLY))}get inlineCssClass(){return this?.slot==="trigger-start"?"inline-start":"inline-end"}set inline(r){i(r)?(this.setAttribute(t.INLINE,""),this.#t()):(this.removeAttribute(t.INLINE),this.#o())}get inline(){return i(this.getAttribute(t.INLINE))}#t(){this.button?.classList.add("style-inline",this.inlineCssClass)}#o(){this.button?.classList.remove("style-inline",this.inlineCssClass)}set inheritColor(r){i(r)?(this.setAttribute(t.INHERIT_COLOR,""),this.button?.classList.add("inherit-color")):(this.removeAttribute(t.INHERIT_COLOR),this.button?.classList.remove("inherit-color"))}get inheritColor(){return this.hasAttribute(t.INHERIT_COLOR)}};n=a([d("ids-trigger-button"),s(l)],n);export{n as a};
