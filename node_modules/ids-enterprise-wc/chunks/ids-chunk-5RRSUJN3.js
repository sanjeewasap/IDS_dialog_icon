import{a as E}from"./ids-chunk-6I35WZF4.js";import{a as I}from"./ids-chunk-BGMGLI6R.js";import{a as w}from"./ids-chunk-4LNK4CO7.js";import{a as u,b as l,c as b,d as C,e as h,f as T}from"./ids-chunk-OS6AOX2T.js";import{a as k}from"./ids-chunk-WGF76AHI.js";import{a as g}from"./ids-chunk-N7RNTKMO.js";import{a as A}from"./ids-chunk-RRSHSZ55.js";import{a as y}from"./ids-chunk-AKCO43TX.js";import{a as m,b as f}from"./ids-chunk-XE4WFW5M.js";import{a as x}from"./ids-chunk-GFV2Z7F5.js";import{e}from"./ids-chunk-QPDOZZIG.js";import{a as i,b as v}from"./ids-chunk-EQJWBFQ2.js";import{a as p}from"./ids-chunk-U7OOVFXE.js";var S=`
/**
...
:host([loading-indicator-only=true]) ::slotted(.slot-loading-indicator) {
  ...
  left: 0;
  right: 0;
}`;var N=k(g(E(w(A(I(y(x))))))),d=class extends N{shouldUpdate=!1;constructor(){super(),Object.keys(b).forEach(t=>{this.state[t]=b[t]}),Object.defineProperty(this,"tabIndex",{get:()=>this.#t,set:t=>{this.#t=t},configurable:!0,enumerable:!0})}connectedCallback(){super.connectedCallback(),this.#o(),this.shouldUpdate=!0,this.getAttribute("width")&&(this.width=this.getAttribute("width"))}#o(){this.hasAttribute(i.ICON)&&this.appendIcon(this.getAttribute(i.ICON)),this.hasAttribute(i.TEXT)&&this.appendText(this.getAttribute(i.TEXT)),this.setAriaText();let t=this.button?.classList.contains("ids-icon-button");this.setupRipple(this.button,t?35:50),this.setIconAlignment(),this.refreshProtoClasses()}static get attributes(){return[...super.attributes,...C]}colorVariants=["alternate","alternate-formatter"];get protoClasses(){let t=this.querySelector("span:not(.audible), ids-text:not([audible])");return this.iconEl&&!t?["ids-icon-button"]:["ids-button"]}refreshProtoClasses(){if(!this.button)return;let t=this.button.classList,o=this.protoClasses;t.remove(...T),t.add(...o)}template(){let t="",o="",n="",r='tabindex="0"',s="";this.state?.cssClass&&(t=` ${this.state.cssClass.join(" ")}`),this.state?.disabled&&(n=' disabled="true"'),this.state?.tabIndex&&(r=`tabindex="${this.state.tabIndex}"`),this.state&&this.state?.appearance!=="default"&&(s=` btn-${this.state.appearance}`),this.hasAttribute(i.SQUARE)&&(t+=" square"),this.hasAttribute(i.NO_PADDING)&&(t+=" no-padding"),this.protoClasses.length&&(o=`${this.protoClasses.join(" ")}`);let c="";return this.state?.iconAlign&&(c=` align-icon-${this.state?.iconAlign}`),`<button part="button" class="${o}${s}${c}${t}" ${r}${n}>
      <slot></slot>
      <slot name="loading-indicator"></slot>
    </button>`}onHiddenChange(t){let o=e(t);this.shouldUpdate=!1,o?this.setAttribute(i.HIDDEN,""):this.removeAttribute(i.HIDDEN),this.shouldUpdate=!0,this.state.hidden=o,this.button&&(this.button.hidden=o)}setAriaText(){this.container&&this.container.setAttribute(v.ARIA_LABEL,this.text?.trim()||"Button")}get button(){return this.shadowRoot?.querySelector("button")||null}set cssClass(t){let o=t,n=[],r=[].concat(this.state.cssClass);if(Array.isArray(t)?(n=t,o=t.join(" ")):typeof t=="string"&&t.length&&(n=t.split(" ")),this.state.cssClass=n,n.length?this.setAttribute(i.CSS_CLASS,o.toString()):this.removeAttribute(i.CSS_CLASS),!this.button)return;let s=this.button.classList,c=Array.from(s);r.forEach(a=>{n.includes(a)||s.remove(a)}),n.forEach(a=>{c.includes(a)||s.add(a)})}get cssClass(){return this.state.cssClass}set disabled(t){let o=e(t);this.shouldUpdate=!1,o?this.setAttribute(i.DISABLED,""):this.removeAttribute(i.DISABLED),this.shouldUpdate=!0,this.state.disabled=o,this.button&&(this.button.disabled=o)}get disabled(){return this.state.disabled}set#t(t){let o=Number(t);if(this.removeAttribute(i.TABINDEX),Number.isNaN(o)||o<-1){this.state.tabIndex=0,this.button?.setAttribute(i.TABINDEX,"0");return}this.state.tabIndex=o,this.button?.setAttribute(i.TABINDEX,`${o}`)}get#t(){return this.state.tabIndex}set icon(t){if(typeof t!="string"||!t.length){this.removeAttribute(i.ICON),this.state.icon=void 0,this.removeIcon();return}this.state.icon=t,this.setAttribute(i.ICON,t),this.appendIcon(t)}get icon(){return this.iconEl?.getAttribute("icon")}get iconEl(){return this.querySelector("ids-icon")}set iconAlign(t){h.includes(`align-icon-${t}`)||(t=void 0),this.state.iconAlign=t,this.setIconAlignment()}get iconAlign(){return this.state?.iconAlign}get width(){return this.getAttribute(i.WIDTH)}set width(t){if(!t){this.removeAttribute(i.WIDTH),this.style.width="",this.button&&(this.button.style.width="");return}t.indexOf("%")!==-1?(this.style.width=t,this.button&&(this.button.style.width="")):(this.style.width="",this.button&&(this.button.style.width=t)),this.setAttribute(i.WIDTH,t)}appendIcon(t){let o=this.querySelector("ids-icon"),n=this.iconAlign,r=n==="end"?"beforeend":"afterbegin";o?(o.icon!==t&&(o.icon=t,this.setIconAlignment()),n==="end"&&this.hasIncorrectEndElement()?this.append(o):this.hasIncorrectStartElement()&&this.prepend(o)):this.insertAdjacentHTML(r,`<ids-icon icon="${t}" class="ids-icon"></ids-icon>`),this.refreshProtoClasses()}removeIcon(){let t=this.querySelector("ids-icon");t&&t.remove(),this.setIconAlignment(),this.refreshProtoClasses()}setIconAlignment(){if(!this.button)return;let t=this.iconAlign,o=this.icon;if(this.button.classList.remove(...h),t&&o){this.button.classList.add(`align-icon-${t}`);let n=this.hasIncorrectStartElement(),r=this.hasIncorrectEndElement();(n||r)&&this.appendIcon(o)}}hasIncorrectStartElement(){return this.iconAlign==="start"&&!this.children[0].isEqualNode(this.iconEl)}hasIncorrectEndElement(){return this.iconAlign==="end"&&!this.children[this.children.length-1].isEqualNode(this.iconEl)}set text(t){if(this.removeAttribute(i.TEXT),typeof t!="string"||!t.length){this.state.text="",this.removeText();return}this.state.text=t,this.appendText(t)}get text(){let t=this.querySelector("span:not(.audible)");return t&&t.textContent?.length?t.textContent:this.textContent}appendText(t){let o=this.querySelector("span:not(.audible)"),n=this.iconAlign,r=n==="end"?"afterbegin":"beforeend";o?(o.textContent=t,this.setAriaText(),n==="end"&&this.hasIncorrectEndElement()?this.prepend(o):n==="start"&&this.hasIncorrectStartElement()&&this.append(o)):this.insertAdjacentHTML(r,`<span>${t}</span>`),this.refreshProtoClasses()}removeText(){let t=this.querySelector("span:not(.audible)");t&&t.remove(),this.refreshProtoClasses()}set appearance(t){!t||u.indexOf(t)<=0?(this.removeAttribute(i.APPEARANCE),this.state.appearance=u[0]):(this.setAttribute(i.APPEARANCE,t),this.state.appearance!==t&&(this.state.appearance=t)),this.setAppearanceClass(t)}get appearance(){return this.state.appearance}set type(t){t&&l.includes(t)?(this.setAttribute(i.TYPE,t),this.button?.setAttribute(i.TYPE,t),this.state.type!==t&&(this.state.type=t)):(this.removeAttribute(i.TYPE),this.button?.removeAttribute(i.TYPE),this.state.type=l[0])}get type(){return this.state.type}set noMargins(t){if(e(t)){this.setAttribute(i.NO_MARGINS,""),this.container?.classList.add(i.NO_MARGINS);return}this.removeAttribute(i.NO_MARGINS),this.container?.classList.remove(i.NO_MARGINS)}get noMargins(){return e(this.getAttribute(i.NO_MARGINS))}set noPadding(t){let o=this.noPadding,n=e(t);o!==n&&(n?(this.container?.classList.add(i.NO_PADDING),this.setAttribute(i.NO_PADDING,"true")):(this.container?.classList.remove(i.NO_PADDING),this.removeAttribute(i.NO_PADDING)))}get noPadding(){return e(this.getAttribute(i.NO_PADDING))}set square(t){let o=e(t);this.button&&(o&&!this.button.classList.contains("square")?this.button.classList.add("square"):!o&&this.button.classList.contains("square")&&this.button.classList.remove("square")),o&&!this.hasAttribute(i.SQUARE)?this.setAttribute(i.SQUARE,""):!o&&this.hasAttribute(i.SQUARE)&&this.removeAttribute(i.SQUARE)}get square(){return this.hasAttribute(i.SQUARE)}setAppearanceClass(t){this.button&&u.forEach(o=>{let n=`btn-${o}`;if(t===o){o!=="default"&&!this.button?.classList.contains(n)&&this.button?.classList.add(n);return}this.button?.classList.contains(n)&&this.button?.classList.remove(n)})}focus(){this.button?.focus()}onColorVariantRefresh(){let t=this.querySelectorAll("ids-icon"),o=this.querySelectorAll("ids-text, span"),n=r=>{r instanceof HTMLSpanElement||(r.colorVariant=this.colorVariant)};[...t,...o].forEach(n)}};d=p([m("ids-button"),f(S)],d);export{S as a,d as b};
